...
<html>
	<head>
		...
		<title><?php echo $_GET['name']; ?> &raquo; Warehouses </title>
	</head>
	<body>
		...
		<div class="pure-g-r homebody">
				...
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h1>Available <!--hotels and -->Warehouse in <?php echo $_GET['name']; ?></h1></div></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=right><h2>Welcome <?php echo $_SESSION['NAME']; ?></h2></div></div>
				
				<div class="pure-u-1-3"></div>
				<div class="pure-u-1-3"><div class="pure-u-1-1" align=center><h2>Please choose the place you want to book your storage at</h2></div></div>
		...
		*/
		...
		while($row = mysql_fetch_assoc($result))
		{
			echo '<div class="pure-u-1-2 homename">
				...
				<div class="pure-u-1-2 white"><div style="color:#00b0ff !important; display:inline-block !important; line-height:24px !important; font-size: 24px; font-weight: bold;">&#8377;'.$row['price'].' </div><div style="font-size:18px;">Per Day</div> </div>
				<div class="pure-u-1-1" style="margin-left:184px;"><a href="book.php?type=home&hid='.$row['homeid'].'&cityid='.$cid.'&success=0"><input type="button" value="Yes this is where I want to book my storage" /></a></div>				
				<br/>
			</div>';
		}
		?>	
